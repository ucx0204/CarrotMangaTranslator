...
const ALLOWED_INTERNAL_BOUNDARY_MOCKS = new Set([
  ...
  "tests/bubbleOnnxRuntime.test.ts::../src/main/bubbleLayout/nativeOrt",
  ...
  "tests/libraryTransactionPublication.test.ts::../src/main/appPaths",
  "tests/libraryTransactionRecovery.test.ts::../src/main/appPaths",
  "tests/shareImportTransactionRecovery.test.ts::../src/main/appPaths",
  "tests/workContextResetTransaction.test.ts::../src/main/appPaths",
