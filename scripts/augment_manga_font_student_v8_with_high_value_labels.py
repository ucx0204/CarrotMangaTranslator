#!/usr/bin/env python3
"""Overlay sealed high-value visual labels onto a v8 role/family NPZ.
...
eligibility policy and retained as explicit reviewed negatives.
"""
...
SCHEMA = "manga-font-student-v8-high-value-overlay-dataset-v1"
OWNER = "carrot-manga-translator/manga-font-student-v8-high-value-overlay-dataset-v1"
MARKER_FILE = ".manga-font-student-v8-high-value-overlay-dataset-v1-owned.json"
...
def validate_output(
    ...
    if (
        ...
        or int(counts.get("high_value_overlay_rows", -1)) < 1
...
def main() -> None:
    ...
    try:
        ...
        raise SystemExit(f"v8 high-value overlay error: {error}") from error
