...
- Current version information: [v1.2.1 release notes](docs/release-notes/v1.2.1.md)
...
1. Download and run the latest installer, such as `CarrotMangaTranslator-Setup-v1.2.1.exe`, from [Releases](https://github.com/ucx0204/CarrotMangaTranslator/releases).
