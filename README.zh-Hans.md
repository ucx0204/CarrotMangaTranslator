...
- 当前版本说明：[v1.2.0 更新说明](docs/release-notes/v1.2.0.md)
...
1. 前往 [Releases](https://github.com/ucx0204/CarrotMangaTranslator/releases)，下载并安装类似 `CarrotMangaTranslator-Setup-v1.2.0.exe` 的最新安装包。
