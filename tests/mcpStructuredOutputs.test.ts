...
it("publishes real 2020-12 output schemas for every existing tool, cached from runtime contracts", () => {
  ...
  expect(Object.keys(mcpOutputSchemas)).toEqual(
    expect.arrayContaining([
      ...
      "carrot_get_text_file_import",
      "carrot_apply_text_file_import",
      "carrot_preflight_context_export",
      "carrot_export_context_json",
      "carrot_preview_context_import",
      "carrot_apply_context_import",
      "carrot_get_output_delivery",
      "carrot_list_context_proposals",
