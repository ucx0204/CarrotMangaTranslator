  ...
  return {
    tools: [
      ...
      ...(enabled
        ...
        : []),
      createMcpBatchTool({
        name: "carrot_get_selection_analysis",
        schema: McpSelectionAnalysisGetSchema,
        scopes: ["carrot.read"],
        write: false,
        description:
        ...
        execute: async (value, owner, guard) => {
          ...
          if (
            ...
            job.result?.selectionAnalysis?.analysisId !== input.analysisId
          )
            throw new McpEditError(
              "not_found",
              "A completed owned selection analysis is required.",
            );
