...
const OVERLAY_PROMPT_SECTIONS = [
  ...
  [
    ...
    "Outside fixed-blocks refinement: For textRole sound, default to confidence below 1.00. Use confidence 1.00 only for complete, common, unmistakable SFX where the Japanese reading and Korean sound lettering are both certain. If any part is doubtful, use confidence below 1.00; the app will discard uncertain sound-effect records.",
  ...
  [
    ...
    "Outside fixed-blocks refinement: For every SFX, accuracy and omission are more important than coverage. Most SFX should be omitted or set below confidence 1.00 unless the exact source glyphs, the sound class, and the Korean effect lettering are all clear.",
    ...
    "Outside fixed-blocks refinement: When reviewing a previous-pass SFX, do not preserve its Korean wording for stability. Re-read the image from scratch; if the previous SFX sounds clumsy, too long, generic, or merely possible, lower confidence below 1.00 or skip it.",
