...
export function buildWorkContextAnalysisPrompt({
  ...
  return {
    ...
    userPrompt: [
      ...
      "- 인명, 별명, 호칭, 장소명, 조직명, 왕국명, 학교명, 연구회명, 마법/속성/아이템/신물/효과음처럼 이후 번역 통일에 필요한 항목을 적극적으로 담아라.",
      ...
      "- note에는 근거가 된 화 제목, 페이지 이름, 짧은 문맥을 적어라.",
      ...
      "- 원문/기존 번역에서 근거를 찾을 수 없는 항목은 넣지 마라. 분류만 애매하면 term 또는 other로 두고 confidence를 낮춰라.",
      "",
