...
**[v2.7.13 다운로드](https://github.com/ucx0204/CarrotMangaTranslator/releases/tag/v2.7.13)** · [변경 사항](docs/release-notes/v2.7.13.md) · [오류·제안](https://github.com/ucx0204/CarrotMangaTranslator/issues)
...
이 문서는 v2.7.13을 기준으로 합니다. 화면은 실제 앱 컴포넌트에 예제 데이터를 넣어 캡처했습니다. 예제 원고·번역은 기능 설명용이며 모델 성능 비교 자료가 아닙니다. [캡처와 예제 출처](docs/images/readme-v2712/README.md)
