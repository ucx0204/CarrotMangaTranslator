...
- 현재 페이지 또는 전체 화의 번역문/OCR 원문을 `텍스트 모아보기`로 확인하고 복사하거나 TXT로 저장합니다.
...
- `2차 번역 (품질 향상)`: 1차 번역 후 AI가 용어, 캐릭터, 맥락을 다시 정리하고 그 결과를 반영해 재번역합니다. 품질은 좋아질 수 있지만 전체 페이지를 다시 처리하므로 시간이 더 걸립니다.
