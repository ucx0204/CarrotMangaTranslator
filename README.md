...
- 현재 버전 안내: [v1.4.0 패치노트](docs/release-notes/v1.4.0.md)
...
1. [Releases](https://github.com/ucx0204/CarrotMangaTranslator/releases)에서 `CarrotMangaTranslator-Setup-v1.4.0.exe` 같은 최신 설치 파일을 받아 설치합니다.
