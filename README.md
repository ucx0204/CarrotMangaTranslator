...
- 다운로드: [v2.5.0](https://github.com/ucx0204/CarrotMangaTranslator/releases/tag/v2.5.0) · [이전 버전](https://github.com/ucx0204/CarrotMangaTranslator/releases)
- 패치노트: [v2.5.0](docs/release-notes/v2.5.0.md)
