...
- 目前版本說明：[v1.6.2 更新說明](docs/release-notes/v1.6.2.md)
...
1. 前往 [Releases](https://github.com/ucx0204/CarrotMangaTranslator/releases)，下載並安裝類似 `CarrotMangaTranslator-Setup-v1.6.2.exe` 的最新安裝檔。
