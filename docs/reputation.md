...
| Current stable release      | [v1.9.0 on 30 July 2026](https://github.com/ucx0204/CarrotMangaTranslator/releases/tag/v1.9.0)                                                               |
...
signature. The v1.9.0 Windows installer is unsigned and is not covered by the
SignPath Foundation policy.

The v1.9.0 Apple Silicon artifacts are ad-hoc signed for integrity, without an
